...
//multiplication - Умножаване | Отпечатваме резултата и дали той е четен или нечетен.

//division - Делене | Отпечатваме резултата
//modularDivision - Модулно делене | Остатъка

//"Cannot divide {N1} by zero" | В случай на деление с 0.